...
//		}
		...
		while (!currRound.isGameOver()){
			...
			if (isBlueTurn){
				...
				if (ch == 1 || ch == 3){
					currRound = pl.minimax(currRound,3,true);
					endTime = System.currentTimeMillis();
					
				}else if (ch == 2 || ch == 4){
					abFlag = true;
					abd = pl.alphabeta(currRound, 3, true, alpha, beta);
					endTime = System.currentTimeMillis();
				...
				if (ch == 1 || ch == 4){
					currRound = pl.minimax(currRound,3,false);
					endTime = System.currentTimeMillis();
				}else if (ch == 2 || ch == 3){
					abFlag = true;
					abd = pl.alphabeta(currRound, 3, false, alpha, beta);
					endTime = System.currentTimeMillis();
				}
...
//			System.out.println("Blue Score: " + score[0]);
//			System.out.println("Green Score: " + score[1]);
